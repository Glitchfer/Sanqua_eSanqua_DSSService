...
// Repository
const Repository = require("../repository/leadingreportrepo.js");
...
const _xClassName = "LeadingReportService";

class LeadingReportService {
  async save(pParam) {
    var xJoResult;
    var xAct = pParam.act;
    delete pParam.act;
    ...
    try {
      ...
      if (xFlagProcess) {
        ...
        if (xAct == "add") {
          ...
          if (xFlagProcess) {
            pParam.leading_date =
              pParam.leading_date != null && pParam.leading_date != ""
                ? moment(pParam.leading_date).format("YYYY-MM-DD")
                : null;
...
module.exports = LeadingReportService;
