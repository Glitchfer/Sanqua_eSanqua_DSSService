...
// Repository
const Repository = require("../repository/accidentitemdescrepo.js");
...
const _xClassName = "AccidentItemDescService";

class AccidentItemDescService {
  async save(pParam) {
    var xJoResult;
    var xAct = pParam.act;
    delete pParam.act;
...
module.exports = AccidentItemDescService;
