...
module.exports = (app) => {
	...
	arrValidate = [
		...
		check('audit_date').not().isEmpty().withMessage('Parameter audit_date can not be empty'),
		check('audit_type_id').not().isEmpty().isInt().withMessage('Parameter audit_type_id can not be empty and must be integer')
	];
	...
	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id can not be empty') ];
	app.post(_rootAPIPath + '/set_to_draft', arrValidate, _auditController.setToDraft);
	...
	app.post(_rootAPIPath + '/generate_form', arrValidate, _auditController.generateFormAudit);
	// arrValidate = [];
	...
	arrValidate = [];
	arrValidate = [
		check('id', 'Parameter id can not be empty').not().isEmpty()
	];
	app.get(_rootAPIPath + '/item/detail/:id', arrValidate, _auditController.itemDetail);
	
	arrValidate = [];
	arrValidate = [
		check('act').not().isEmpty().withMessage('Parameter action can not be empty'),
		check('id', 'Parameter id can not be empty and must be integer').not().isEmpty()
	];
	...
	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id can not be empty') ];
	app.post(_rootAPIPath + '/item/submit', arrValidate, _auditController.itemSubmit);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id can not be empty') ];
	app.post(_rootAPIPath + '/item/cancel', arrValidate, _auditController.itemCancel);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter document_id can not be empty') ];
	app.post(_rootAPIPath + '/item/verify', arrValidate, _auditController.itemVerify);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id can not be empty') ];
	app.post(_rootAPIPath + '/item/set_to_draft', arrValidate, _auditController.itemSetDraft);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id can not be empty') ];
	app.post(_rootAPIPath + '/item/unused', arrValidate, _auditController.itemSetUnused);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id can not be empty') ];
	app.delete(_rootAPIPath + "/item/delete/:id", arrValidate, _auditController.itemDelete);

	arrValidate = [];
	arrValidate = [
		check('act').not().isEmpty().withMessage('Parameter action can not be empty')
	];
	app.post(_rootAPIPath + '/member/save', arrValidate, _auditController.memberSave);

	arrValidate = [];
	arrValidate = [ check('id').not().isEmpty().withMessage('Parameter id can not be empty') ];
	app.delete(_rootAPIPath + "/member/delete/:id", arrValidate, _auditController.memberDelete);
};
