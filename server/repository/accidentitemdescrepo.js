...
// Model
const _modelDb = require("../models").tr_accidentitemdescs;
const _modelInspection = require("../models").tr_inspections;

const Utility = require("peters-globallib-v2");
const _utilInstance = new Utility();

const _xClassName = "AccidentItemDesc";

class AccidentItemDesc {
  constructor() {}
  ...
  async list(pParam) {
    ...
    try {
      ...
      if (pParam.hasOwnProperty("inspection_id")) {
        if (pParam.inspection_id != "") {
          xWhereAnd.push({
            inspection_id: pParam.inspection_id,
          });
        }
      }
...
module.exports = AccidentItemDesc;
