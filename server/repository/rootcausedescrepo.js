...
// Model
const _modelDb = require("../models").tr_rootcauseitemdescs;
const _modelRootProblem = require("../models").tr_rootproblems;

const Utility = require("peters-globallib-v2");
const _utilInstance = new Utility();

const _xClassName = "RootCauseDesc";
...
class RootCauseDesc {
  ...
  async list(pParam) {
    ...
    try {
      ...
      if (pParam.hasOwnProperty("rootproblem_id")) {
        if (pParam.rootproblem_id != "") {
          xWhereAnd.push({
            rootproblem_id: pParam.rootproblem_id,
          });
        }
      }
